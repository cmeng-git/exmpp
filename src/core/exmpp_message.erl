...
-spec normal(binary() | string()) -> xmlel().
...
-spec normal(binary() | string(), binary() | string()) -> xmlel().
...
-spec make_normal(xmlname()) -> xmlel().
...
-spec make_normal(xmlname(), binary() | string()) -> xmlel().
...
-spec make_normal(xmlname(), binary() | string(), binary() | string()) -> xmlel().
...
-spec chat(binary() | string(), binary() | string()) -> xmlel().
...
-spec make_chat(xmlname(), binary() | string()) -> xmlel().
...
-spec make_chat(xmlname(), binary() | string(), binary() | string()) -> xmlel().
...
-spec groupchat(binary() | string()) -> xmlel().
...
-spec groupchat(binary() | string(), binary() | string()) -> xmlel().
...
-spec make_groupchat(xmlname()) -> xmlel().
...
-spec make_groupchat(xmlname(), binary() | string()) -> xmlel().
...
-spec make_groupchat(xmlname(), binary() | string(), binary() | string()) -> xmlel().
...
-spec headline(binary() | string()) -> xmlel().
...
-spec headline(binary() | string(), binary() | string()) -> xmlel().
...
-spec make_headline(xmlname()) -> xmlel().
...
-spec make_headline(xmlname(), binary() | string()) -> xmlel().
...
-spec make_headline(xmlname(), binary() | string(), binary() | string()) -> xmlel().
...
-spec get_type(xmlel()) -> messagetype().
...
-spec set_type(xmlel(), messagetype() | binary() | string()) -> xmlel().
...
-spec get_subject(xmlel()) -> binary() | undefined.
...
-spec set_subject(xmlel(), binary() | string()) -> xmlel().
...
-spec get_body(xmlel()) -> binary() | undefined.
...
-spec set_body(xmlel(), binary() | string()) -> xmlel().
...
-spec get_thread(xmlel()) -> binary() | undefined.
...
-spec set_thread(xmlel(), binary()) -> xmlel().
